...
const CURSOR = "<|cursor|>"
const DEFAULT_WORKSPACE = "/tmp/chipmate-c-embedded-ui-matrix"
const DEFAULT_QEMU_WORKSPACE = "/tmp/chipmate-qemu-completion-ui-138"
...
export function completionUiWorkspaceSettings(options: Pick<UiMatrixOptions, "apiBaseUrl" | "model" | "profile">) {
  ...
  if (options.apiBaseUrl) settings["chipmate.completion.apiBaseUrl"] = options.apiBaseUrl
