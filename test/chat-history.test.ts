...
describe("chat history flow", () => {
  ...
  test("queues busy chat sends and drains them FIFO after terminal send states", () => {
    ...
    expect(chatViewSource).toContain("this.enqueueChatSend(text, options, mentioned.uris, mentioned.refs, clientQueueID)")
    ...
    expect(chatViewSource).toContain("await this.processSendMessage(next.text, next.options, mentioned.uris)")
