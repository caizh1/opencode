...
describe("chat history flow", () => {
  ...
  test("collapses the composer and context panel", () => {
    ...
    expect(chatHtmlSource).toContain("statusIcon")
    expect(chatHtmlSource).toContain("statusRingIcon")
    expect(chatHtmlSource).toContain("statusBadge")
    expect(chatHtmlSource).toContain("bookOpen")
    expect(chatHtmlSource).toContain("radar")
    ...
    expect(chatHtmlSource).toContain("ringIcon: STATUS_ICONS.radar")
    ...
    expect(chatHtmlSource).toContain("transform: translateY(-1px)")
