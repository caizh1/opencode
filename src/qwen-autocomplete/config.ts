...
export function readQwenAutocompleteConfig(): QwenAutocompleteConfig {
  ...
  return {
    enabled: bool(cfg.get("completion.enabled"), false),
    provider: provider(cfg.get("completion.provider")),
    ...
    contextLength: num(cfg.get("completion.contextLength"), 0, 0, 1_000_000),
    recentlyEditedEnabled: bool(cfg.get("completion.context.recentlyEdited.enabled"), false),
    recentlyEditedInjectIntoPrompt: bool(cfg.get("completion.context.recentlyEdited.injectIntoPrompt"), false),
    ...
    recentlyOpenedEnabled: bool(cfg.get("completion.context.recentlyOpened.enabled"), false),
    recentlyOpenedInjectIntoPrompt: bool(cfg.get("completion.context.recentlyOpened.injectIntoPrompt"), false),
    ...
    importDefinitionsEnabled: bool(cfg.get("completion.context.importDefinitions.enabled"), false),
    importDefinitionsInjectIntoPrompt: bool(cfg.get("completion.context.importDefinitions.injectIntoPrompt"), false),
    ...
    rootPathEnabled: bool(cfg.get("completion.context.rootPath.enabled"), false),
    rootPathInjectIntoPrompt: bool(cfg.get("completion.context.rootPath.injectIntoPrompt"), false),
