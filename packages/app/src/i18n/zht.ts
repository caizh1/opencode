...
export const dict = {
  ...
  "toast.file.saved.title": "檔案已儲存",
  "toast.file.saveFailed.title": "儲存檔案失敗",
  ...
  "session.files.edit.edit": "編輯",
  "session.files.edit.discard": "放棄",
  "session.files.edit.unsaved": "未儲存",
  "session.files.edit.saved": "已儲存",
  "session.files.edit.saveFailed": "儲存失敗",
  "session.files.edit.readOnly": "唯讀",
  "session.files.edit.externalChange": "檔案已在外部變更。儲存會覆蓋磁碟上的最新版本。",
  "session.files.edit.discardConfirm": "放棄「{{name}}」中未儲存的變更嗎？",
