...
export const SettingsGeneral: Component = () => {
  ...
  return (
    ...
    >
      <div
        data-component="settings-page-header"
        class="sticky top-0 z-10 bg-[linear-gradient(to_bottom,var(--surface-stronger-non-alpha)_calc(100%_-_24px),transparent)]"
      >
        <div data-slot="settings-page-header-content" class="flex flex-col gap-1 pt-6 pb-8">
          <h2 data-slot="settings-page-title" class="text-16-medium text-text-strong">
            {language.t("settings.tab.general")}
          </h2>
        </div>
      </div>

      <div data-slot="settings-page-sections" class="flex flex-col gap-8 w-full">
        <GeneralSection />
